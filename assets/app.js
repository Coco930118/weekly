...
- X・Threads・X診断・Threads診断のFinal Editor回答では、毎回AとBを同じ回答内で比較できる形で提示する。「① A｜いつもの構成」「② B｜澄んだ短文」の2案を冒頭で明示し、片方だけを先に確定したり、別回答へ分けたりしない。
...
Final Editor回答では、修正の有無にかかわらず、毎回「① A｜いつもの構成」「② B｜澄んだ構成」を同じ回答内で比較できる形で提示する。片方だけを先に確定したり、別回答へ分けたりしない。
