...
- Final Editorの選択肢は媒体ごとに固定する。X短文・通常X・通常Threadsだけは、毎回A/B/Cの3案を同じ回答内の「選択できる3案」として提示し、「① A｜いつもの構成」「② B｜澄んだ短文」「③ C｜Cocoのぼやき」を明示する。X診断・Threads診断は従来どおりA/Bの2案、noteも従来どおりA/Bの2案とし、Cを増やさない。片方だけを先に確定したり、別回答へ分けたりしない。ChatGPT側の具体的なUI名称・Writing Block・タブ実装方法は指定しない。
