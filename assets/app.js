...
- Coco本人がA/Bから選ぶFinal Editor回答は、媒体・投稿種別を問わず、毎回A/Bの2案を同じ回答内の「選択できる2案」として提示する。X短文・X・Threads・X診断・Threads診断を含め、診断Final Editorで使っているのと同じ出し方に統一し、「① A｜いつもの構成」「② B｜澄んだ短文」を2つの候補として明示する。片方だけを先に確定したり、別回答へ分けたりしない。ChatGPT側の具体的なUI名称・Writing Block・タブ実装方法は指定しない。
