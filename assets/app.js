...
診断本文と解説コメントを1セットで編集する（X診断=comment、Threads診断=reply_1）。解説コメントの見出しは「A｜短い選択ラベル」のように、A/B/C/D＋選択の意味を思い出せる簡潔なラベルを添える。元の選択肢全文は再掲せず、ラベルは原文の意味を変えない短い要約にする。各解説・見るポイント／一手・結び・診断接続まで本文と整合させ、X/Threadsで読み切れる量と視認性に整える。
