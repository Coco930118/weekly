...
# 適用は**9/1週から**（2026-09-02 Coco決定。旧「9/8週の生成から」を前倒し）。
# ただし配信済みの本文は直せないので、実際に効くのは未配信の 9/3 から。
# 9/1・9/2 の4本（x_01〜x_04）は測ると全部かかるが、直さない
# （CLAUDE.md「配信が終わった週の本文」と同じ扱い）。
FOLD = 280
FOLD_FROM = '2026-09-03'
